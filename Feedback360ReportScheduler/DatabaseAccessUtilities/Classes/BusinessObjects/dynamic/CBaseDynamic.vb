...
#Region "MustOverride/Overridable"
    ...
    'Public MustOverride Property IsDeleted() As Boolean
...
#Region "Protected - Insert/Update"
    Protected Overrides Sub Insert(ByVal txOrNull As IDbTransaction)
        Dim obj As Object = DataSrc.Insert(Me.TableName, Me.PrimaryKeyName, Me.InsertPrimaryKey, Me.SaveParameters(Me.InsertPrimaryKey), txOrNull, Me.OracleSequenceName)
        If Not Me.InsertPrimaryKey Then Me.PrimaryKeyValue = obj
    End Sub
...
#Region "Select IList"
    ...
    Private Function SelectCols(ByVal tableOrJoin As String) As String
        ...
        For Each i As String In Me.SelectColumns.Split(CChar(","))
            ...
            If i.Contains(".") Then sb.Append(i) Else sb.Append(Me.ViewName).Append(".").Append(i.Trim())
        Next
        Return sb.ToString
    End Function
    ...
    End Function
    Protected Function DeleteWhere(ByVal where As CCriteria, ByVal txOrNull As IDbTransaction) As Integer
        DeleteWhere = DataSrc.DeleteWhere(Me.TableName, where, txOrNull)
        CacheClear()
    End Function
#End Region
...
#Region "Select Datasets (Rarely used, normally return IList)"
    ...
    Public Function SelectWhere_Dataset(ByVal where As CCriteriaList) As DataSet
        Return DataSrc.SelectWhere_Dataset(Me.SelectColumns, Me.TableName, Me.OrderByColumns, where)
    End Function
...
#Region "ToXml"
    Public Overrides Sub ToXml(ByVal w As XmlWriter)
