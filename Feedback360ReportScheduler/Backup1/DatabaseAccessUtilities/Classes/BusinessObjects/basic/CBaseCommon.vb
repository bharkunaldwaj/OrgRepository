...
#Region "Shared - Get Data From DataRow"
    ...
    Protected Shared Function GetGuid(ByVal dr As DataRow, ByVal columnName As String) As Guid
        Return CAdoData.GetGuid(dr, columnName, Guid.Empty)
    End Function
