...
namespace Questionnaire_BE
{
    ...
    [Serializable]
    public class Survey_AssignQuestionnaire_BE : BE_Base
    {
        public int? AssignmentID { get; set; }
        public int? ProjecctID { get; set; }
        public int? ProgrammeID { get; set; }
        ...
        public DateTime? ModifiedDate { get; set; }
        public int? IsActive { get; set; }
        public List<Survey_AssignmentDetails_BE> AssignmentDetails { get; set; }
        public List<Survey_AccountUser_BE> AssignmentUserDetails { get; set; }
        public int? NewProgrammeID { get; set; }

        public Survey_AssignQuestionnaire_BE()
        {
            this.AssignmentID = null;
            this.ProjecctID = null;
            this.ProgrammeID = null;
