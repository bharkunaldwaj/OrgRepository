...
namespace Questionnaire_BE
{
   public class Project_BE
    {
        ...
        public int? EmailTMPSelfReminder { get; set; }
        ...
        public Project_BE()
        {
            ...
            this.EmailTMPSelfReminder = null;
   ...
   public class Survey_Project_BE
   {
       ...
       public String finish_emailID { get; set; }
       public bool? finish_emailID_Chkbox { get; set; }

       public Survey_Project_BE()
       {
           this.ProjectID = null;
           this.StatusID = null;
           this.Reference = String.Empty;
           ...
           this.finish_emailID= null;
           this.finish_emailID_Chkbox = null;
       } 
