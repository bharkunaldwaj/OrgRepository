...
namespace DBHandler
{
    public sealed class SqlHelper
    {
        ...
        public static string ConnectionString()
        {
            ...
            //strConnection = System.Configuration.ConfigurationSettings.AppSettings["strConnection"].ToString();
            strConnection = System.Configuration.ConfigurationSettings.AppSettings["AegisConnStr"].ToString();
            if (strConnection == null || strConnection.Length == 0) throw new ArgumentNullException("AegisConnStr");
 ...
 values.  This method will query the database to discover the parameters for the 
        /// stored procedure (the first time each stored procedure is called), and assign the values based on parameter order.
        /// </summary>
        /// <remarks>
        /// This method provides no access to output parameters or the stored procedure's return value parameter.
