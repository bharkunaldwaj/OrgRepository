<%@ Page Title="User Management" Language="C#" MasterPageFile="~/Layouts/MasterPages/Survey.master"
    AutoEventWireup="true" CodeFile="AccountUserList.aspx.cs" Inherits="Survey_Module_Admin_AccountUserList" %>
                ...
                <ContentTemplate>
                 ...
                 <div id="divAccount" runat="server" visible="false">
                    ...
                    <asp:ObjectDataSource ID="odsAccountUser" runat="server" 
                        DataObjectTypeName="Admin_BE.Survey_AccountUser_BE" DeleteMethod="DeleteAccountUser" 
                        SelectMethod="GetdtAccountUserListNew" TypeName="Admin_BAO.Survey_AccountUser_BAO" >
                        <SelectParameters>
