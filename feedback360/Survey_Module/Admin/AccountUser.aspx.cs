...
public partial class Survey_Module_Admin_AccountUser : CodeBehindBase
{
    ...
    List<Survey_AccountUser_BE> accountuser_BEList = new List<Survey_AccountUser_BE>();
    ...
    private void SetAccountUserValue(List<Survey_AccountUser_BE> accountuser_BEList)
    {
        try
        {
            //HandleWriteLog("Start", new StackTrace(true));
