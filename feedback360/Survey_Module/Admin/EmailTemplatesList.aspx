<%@ Page Title="Email Templates Management" Language="C#" MasterPageFile="~/Layouts/MasterPages/Survey.master" 
    AutoEventWireup="true" CodeFile="EmailTemplatesList.aspx.cs" Inherits="Survey_Module_Admin_EmailTemplatesList" %>
    ...
    <div id="bodytextcontainer">
        <div class="innercontainer">
            ...
            <div class="Survey_topheadingdetails">
                <h3>
                    <img src="../../Layouts/Resources/images/email.png" runat="server" title="<% $Resources:lblToolTip %>" align="absmiddle" />
                 ...
                 <div id="divAccount" runat="server" visible="false">
                    ...
                    <table width="100%" border="0" cellspacing="5" cellpadding="0">
                        <tr>
                            ...
                            <td width="36%">
                                <asp:DropDownList ID="ddlAccountCode" runat="server" Style="width: 155px; height: 17px;" 
                                    AppendDataBoundItems="True" 
                                    onselectedindexchanged="ddlAccountCode_SelectedIndexChanged" 
                                    AutoPostBack="true" >
                            ...
                            <td width="38%">
                                ...
                                <asp:Button ID="Button1" runat="server" Text="Button" Visible="false" Enabled="false" onclick="Button1_Click" />
                            </td>
                        </tr>
                    ...
                    <asp:GridView ID="grdvEmailTemplates" runat="server" DataSourceID="odsEmailTemplate"
                        ...
                        AllowPaging="True" AllowSorting="True" OnSorting="grdvEmailTemplates_Sorting"
                        OnRowDataBound="grdvEmailTemplates_RowDataBound" DataKeyNames="EmailTemplateID" 
                        EmptyDataText="<center><span class='style3'>No Record Found</span></center>" >
                        <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                            Visible="false" />
                        <Columns>
                            <asp:BoundField DataField="EmailTemplateID" HeaderText="<% $Resources:grdvEmailEmailTempID %>" SortExpression="EmailTemplateID"
                                Visible="False" />
                            <asp:TemplateField HeaderText="Title" SortExpression="Title">
                             ...
                             <asp:BoundField DataField="Code"  HeaderText="<% $Resources:grdvEmailAccountCode %>" SortExpression="Code">
                            <ItemStyle Width="11%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Description" HeaderText="<% $Resources:grdvEmailDesc %>" SortExpression="Description"
                                ItemStyle-Wrap="true">
                                <ItemStyle Width="25%" />
                            </asp:BoundField>
                    ...
                    <table width="100%" border="0">
                        <tr>
                            <td align="left" width="20%">
                                <asp:ImageButton ID="ibtnAddNew" ImageUrl="~/Layouts/Resources/images/Add_New.png" ToolTip="Add New Email Template"
                    ...
                    <asp:ObjectDataSource ID="odsEmailTemplate" runat="server" 
                        DataObjectTypeName="Admin_BE.Survey_EmailTemplate_BE" 
                        DeleteMethod="DeleteEmailTemplate" SelectMethod="GetdtEmailTemplateList" 
                        TypeName="Admin_BAO.Survey_EmailTemplate_BAO" >                        
                        <SelectParameters>
