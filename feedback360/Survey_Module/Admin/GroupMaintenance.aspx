<%@ Page Title="Create New Group" Language="C#" AutoEventWireup="true" CodeFile="GroupMaintenance.aspx.cs"
    Inherits="Survey_Module_Admin_GroupMaintenance" MasterPageFile="~/Layouts/MasterPages/Survey.master" %>
            ...
            <div class="userform">
                ...
                <div align="center">
                    ...
                    <asp:ImageButton ID="imbBack" Visible="false" ImageUrl="~/Layouts/Resources/images/Back.png"
                        CausesValidation="false" runat="server" PostBackUrl="~/Survey_Module/Admin/GroupMaintenanceList.aspx"
