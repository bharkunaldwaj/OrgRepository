<%@ Page Title="" Language="C#" MasterPageFile="~/Layouts/MasterPages/Survey.master" AutoEventWireup="true" CodeFile="ViewCandidateStatus.aspx.cs" Inherits="Survey_Module_Questionnaire_ViewCandidateStatus" %>
