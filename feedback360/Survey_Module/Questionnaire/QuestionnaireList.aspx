<%@ Page Title="Questionnaire Management" Language="C#" MasterPageFile="~/Layouts/MasterPages/Survey.master" AutoEventWireup="true" CodeFile="QuestionnaireList.aspx.cs" Inherits="Module_Questionnaire_QuestionnaireList" %>
                ...
                <ContentTemplate>
                 ...
                 <div id="divAccount" runat="server" visible="false">
                    ...
                    <asp:GridView ID="grdvQuestionnaire" runat="server" DataSourceID="odsQuestionnaire" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Center">
                                ...
                                <ItemStyle HorizontalAlign="Center" Width="2%" />
                               <ItemTemplate>
                                    <a href="#"  onclick="javascript:window.open('../../Survey_Module/Feedback/QuestionReview.aspx?QstnId=<%# Eval("QuestionnaireID") %>','','menubar=no,scrollbars=yes, resizable=yes');"  >
                    ...
                    <asp:ObjectDataSource ID="odsQuestionnaire" runat="server" 
                        DataObjectTypeName="Questionnaire_BE.Survey_Questionnaire_BE" 
