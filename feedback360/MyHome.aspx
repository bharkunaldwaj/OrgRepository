<%@ Page Title="" Language="C#" MasterPageFile="~/Layouts/MasterPages/Home.master" AutoEventWireup="true" CodeFile="MyHome.aspx.cs" Inherits="MyHome" %>
            ...
            <div id="divNavigation" runat="server">
                <div class="main-nav">
                    <ul>
                        ...
                        <li><a href="http://localhost:1541/default.aspx?sessiondata=<%=sessionx %>">
                        <%--<a href="http://personality.i-comment360.com/default.aspx?sessiondata=<%=sessionx %>">--%>
                            <div class="icon">
