<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionReview.aspx.cs" Inherits="Module_Feedback_QuestionReview" %>
...
<head runat="server">
    ...
    <title><asp:Label ID="lblTitle" runat="server" Text="<% $Resources:lblTitle %>"></asp:Label></title>
</head>
<body>
