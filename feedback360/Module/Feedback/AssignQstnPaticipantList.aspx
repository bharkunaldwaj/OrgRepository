<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignQstnPaticipantList.aspx.cs"
    Inherits="Module_Feedback_AssignQstnPaticipantList" %>
                            ...
                            <Columns>
                                ...
                                <%--<asp:BoundField DataField="EmailID" HeaderText="<% $Resources:grdvEmail %>">
                                 ...
                                 <asp:TemplateField HeaderText="<% $Resources:grdvEmail %>">
                                    <ItemTemplate>
                                        <asp:TextBox style="width:250px" ID="txtEmail" runat="server" Text='<%# Eval("EmailID") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:ButtonField CommandName="SelfAssessment" ButtonType="Link" ItemStyle-HorizontalAlign="Center"
                                    ItemStyle-Width="2%" Text="<img id='imgSelfAssessment' runat='server' src='../../Layouts/Resources/images/self-assement-icon.png' title='Self Assessment' />">
                                    <ItemStyle HorizontalAlign="Center" Width="2%" />
                                </asp:ButtonField>
