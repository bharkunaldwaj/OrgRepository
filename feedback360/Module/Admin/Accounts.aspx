<%@ Page Title="Create New Account" Language="C#" MasterPageFile="~/Layouts/MasterPages/Feedback360.master"
    AutoEventWireup="true" CodeFile="Accounts.aspx.cs" Inherits="Module_Admin_Accounts" %>
...
--%>
                        ...
                        <div align="center">
                            ...
                            <asp:ImageButton ID="imbBack" Visible="false" ImageUrl="~/Layouts/Resources/images/Back.png"
                                CausesValidation="false" runat="server" PostBackUrl="~/Module/Admin/AccountList.aspx"
