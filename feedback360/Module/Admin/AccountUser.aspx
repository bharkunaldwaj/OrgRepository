<%@ Page Title="Create New User" Language="C#" MasterPageFile="~/Layouts/MasterPages/Feedback360.master"
    AutoEventWireup="true" CodeFile="AccountUser.aspx.cs" Inherits="Module_Admin_AccountUser" %>
            ...
            <div class="userform">
                ...
                <div align="center">
                    ...
                    <asp:ImageButton ID="imbBack" Visible="false" ImageUrl="~/Layouts/Resources/images/Back.png"
                        CausesValidation="false" runat="server" PostBackUrl="~/Module/Admin/AccountUserList.aspx" ToolTip="Back to list" />
                </div>
                <br />
            </div>
            <!-- start user form -->
