<%@ Page Title="" Language="C#" MasterPageFile="~/Layouts/MasterPages/Feedback360.master" ValidateRequest="false"
    AutoEventWireup="true" CodeFile="EmailParticipant.aspx.cs" Inherits="Module_Admin_EmailParticipant" %>
        ...
        <div class="innercontainer">
            ...
            <%--<asp:UpdatePanel ID="updPanel" runat="server">
                <ContentTemplate>--%>
                    ...
                    <div id="divgridlist" style="overflow-y: auto; overflow-x: hidden; height: 300px; border: 1px;">
                    <asp:GridView ID="grdvCandidateStatus" runat="server" DataSourceID="odsCandidateStatus"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="FirstName" HeaderText="<% $Resources:lblColleagueName %>"
                                SortExpression="FirstName">
                                <ItemStyle Width="15%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="LastName" HeaderText="<% $Resources:lblColleagueLastName %>" SortExpression="LastName">
                                <ItemStyle Width="15%" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="<% $Resources:lblCandidateEmail %>" HeaderStyle-HorizontalAlign="Center">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField runat="server" ID="hdnFirstName" Value='<%# Eval("FirstName") %>' />
                                    ...
                                    <asp:Label runat="server" ID="lblParticipantEmail" Text='<%# Eval("EmailID") %>'> </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
