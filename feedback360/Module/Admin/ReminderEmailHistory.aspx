<%@ Page Title="" Language="C#" MasterPageFile="~/Layouts/MasterPages/Feedback360.master"
    AutoEventWireup="true" CodeFile="ReminderEmailHistory.aspx.cs" Inherits="Module_Admin_ReminderEmailHistory" %>
        ...
        <div class="innercontainer">
            ...
            <asp:UpdatePanel ID="updPanel" runat="server">
                ...
                <ItemStyle Width="10%" />
                    ...
                    <asp:ObjectDataSource ID="odsReminderMailHistory" runat="server" DataObjectTypeName="Admin_BE.ReminderEmailHistory_BE"
                        SelectMethod="GetdtReminderEmailHistoryList" TypeName="Admin_BAO.ReminderEmailHistory_BAO">
