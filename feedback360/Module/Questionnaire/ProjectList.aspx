<%@ Page Title="Project Management" Language="C#" MasterPageFile="~/Layouts/MasterPages/Feedback360.master"
    AutoEventWireup="true" CodeFile="ProjectList.aspx.cs" Culture="en-GB" UICulture="en-US" Inherits="Module_Questionnaire_ProjectList" %>
                ...
                <ContentTemplate>
                 ...
                 <div id="divAccount" runat="server" visible="false">
                    ...
                    <asp:ObjectDataSource ID="odsProject" runat="server" 
                        DataObjectTypeName="Questionnaire_BE.Project_BE" DeleteMethod="DeleteProject" 
                        SelectMethod="GetdtProjectListNew" TypeName="Questionnaire_BAO.Project_BAO" >
