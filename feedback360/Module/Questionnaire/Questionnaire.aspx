<%@ Page Title="Create New Questionnaire" Language="C#" MasterPageFile="~/Layouts/MasterPages/Feedback360.master"
    AutoEventWireup="true" CodeFile="Questionnaire.aspx.cs" Inherits="Module_Questionnaire_Questionnaire" %>
                  ...
                  Text=""  />--%>
                        ...
                        <div align="center">
                            ...
                            <asp:ImageButton ID="imbBack" Visible="false" ImageUrl="~/Layouts/Resources/images/Back.png"
                                CausesValidation="false" runat="server" PostBackUrl="~/Module/Questionnaire/QuestionnaireList.aspx" />
                        </div>
                        <br />
                    </div>
                    <!-- start user form -->
