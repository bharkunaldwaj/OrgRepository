<%@ Page Title="Question Management" Language="C#" MasterPageFile="~/Layouts/MasterPages/Feedback360.master"
    AutoEventWireup="true" CodeFile="QuestionList.aspx.cs" Inherits="Module_Questionnaire_QuestionList" %>
            ...
            <asp:UpdatePanel ID="updPanel" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="grdvQuestions" runat="server" DataSourceID="odsQuestions" AutoGenerateColumns="False"
                        Width="100%" CssClass="grid" AllowPaging="True" AllowSorting="True" PageSize="10"
                        OnRowDataBound="grdvQuestions_RowDataBound" DataKeyNames="QuestionID" EmptyDataText="<% $Resources:lblNoRecordFound %>">
                    ...
                    <asp:ObjectDataSource ID="odsQuestions" runat="server" DataObjectTypeName="Questionnaire_BE.Questions_BE"
                        SelectMethod="GetdtQuestionsListnew" TypeName="Questionnaire_BAO.Questions_BAO"
                        DeleteMethod="DeleteQuestions"></asp:ObjectDataSource>
                </ContentTemplate>
                <Triggers>
                </Triggers>
            </asp:UpdatePanel>
